...
export async function installApp(
  ...
  try {
    ...
    envVars.APP_DATA_DIR = envVars.APP_DATA_DIR || path.join("/DATA/AppData", appId);
    envVars.UMBREL_ROOT = envVars.UMBREL_ROOT || "/DATA";

    console.log(`[Docker] installApp: System defaults - PUID=${envVars.PUID}, PGID=${envVars.PGID}, TZ=${envVars.TZ}`);
