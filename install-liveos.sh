...
if [ -d "/home/me/live-os" ]; then
  ...
  sudo git clone https://github.com/your-repo/live-os.git /home/me/live-os
fi
...
log "Building the frontend with Nx..."
nx build frontend --prod

# Build the NestJS backend using Nx
log "Building the backend with Nx..."
nx build backend
